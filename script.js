...
// Data integrity fix
const categories = ['global', 'calculus', 'trigonometry'];
categories.forEach(c => {
    if (!correctHistory[c]) correctHistory[c] = { correct: 0, total: 0 };
});
...
// --- 2. AUDIO ENGINE (Procedural Thud & Ticks) ---
...
function handleWrong() {
    failSound(); clearInterval(timerId); lives--; // DECREMENT LIFE
    updateHUD(); 
...
function endGame() {
    ...
    badge.innerText = rankObj.name; badge.style.backgroundColor = rankObj.color;
