...
function updateHomeDashboard() {
    ...
    safeSet('high-score', highScore); safeSet('user-callsign', callsign); safeSet('display-callsign', callsign); safeSet('current-rank', r.n);
...
window.shareResult = () => {
    const t = `SYSTEM REPORT: Streak ${score} // Rank [${getRankInfo(score).name}] on STEMANACE. Beat me: ${window.location.href}`;
